...
def banner():
	os.system("clear")
	print("")
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(M))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(M))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(M))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(M))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(M))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(Z))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(Z))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(Z))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(Z))
	print("%s мєнαк 𝐅𝐀𝐈𝐒𝐀𝐋 "%(Z))
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %sмєнαк 𝐅𝐀𝐈𝐒𝐀𝐋                      %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : github.com/HunterFaisalshah007  %s║"%(Z,B,Z))
	print("%s║%s  facebook : https://www.facebook.com/username.r.3/       %s║"%(Z,B,Z))
...
def random_number():
	...
	print(f" {M}FOR EXAMPLE : {Z}[{H}+92317636xxxx{Z}]\n")
